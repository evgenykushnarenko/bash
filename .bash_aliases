...
alias ccat='pygmentize -g -O style=github-dark,linenos=1' # 1. sudo apt install python3-venv python3-pip -y 2. pip install Pygments 3. sudo echo 'export PATH="/home/evgeny/.local/bin:$PATH"' >> .bashrc
